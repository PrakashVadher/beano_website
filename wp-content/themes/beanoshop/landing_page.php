...
<body class="Landing-Page">
			...
			<div class="left-section-main">
				<div class="left-section">
					...
					<div class="pick-up-section">
						...
						<p class="week-days">
							<span class="d-block"><span class="week-name">M - F</span> : <strong> 7am - 4pm </strong> </span>
							<span class="d-block"><span class="week-name">S / S</span> : <strong> 8am - 4pm</strong></span>
						</p>
					</div>
					<div class="copy-rights mt-0">Copyright © 2020<?//php echo date('Y');?> , beanoshop.</div>
				</div>
			</div>
			...
			<div class="right-section landing-p-right">
				<div class="half-checkout">
					...
					<div class="right-two-section">						
						...
						<div class="right-two-section-box last">
	...
	<div class="proceed-section w-100 proceed-btn proceed-btn-checkout" style="display:none;" id="btn-proceed-div">
		<p class="mobile-only-txt-bottom payment-details-bottom">Copyright © 2020 <?//php echo date('Y');?> , beanoshop.</p>		
